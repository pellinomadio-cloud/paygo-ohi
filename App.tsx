            ...
            <div className="space-y-4">
                <div>
                    ...
                    <p className="text-xl font-black text-purple-900 tracking-tight flex items-center justify-between dark:text-white">
                      7916172809
                      <button onClick={() => {navigator.clipboard.writeText('7916172809'); alert('Copied!');}} className="text-[9px] bg-purple-200 text-purple-700 px-2 py-0.5 rounded-md">COPY</button>
                    </p>
                </div>
                <div>
                    <p className="text-[9px] text-purple-400 font-bold uppercase mb-0.5">Account Name</p>
                    <p className="text-base font-bold text-purple-900 uppercase dark:text-white">OHI ABDULSALAM</p>
                </div>
                <div>
                    <p className="text-[9px] text-purple-400 font-bold uppercase mb-0.5">Bank Name</p>
                    <p className="text-base font-bold text-purple-900 uppercase dark:text-white">POCKET APP</p>
                </div>
            </div>
        </div>
