            ...
            <div className="space-y-4">
                <div>
                    ...
                    <p className="text-xl font-black text-purple-900 tracking-tight flex items-center justify-between dark:text-white">
                      9056754564
                      <button onClick={() => {navigator.clipboard.writeText('9056754564'); alert('Copied!');}} className="text-[9px] bg-purple-200 text-purple-700 px-2 py-0.5 rounded-md">COPY</button>
                    </p>
                </div>
                <div>
                    <p className="text-[9px] text-purple-400 font-bold uppercase mb-0.5">Account Name</p>
                    <p className="text-base font-bold text-purple-900 uppercase dark:text-white">OHI AYO ABDULSALAM</p>
                </div>
                <div>
                    <p className="text-[9px] text-purple-400 font-bold uppercase mb-0.5">Bank Name</p>
                    <p className="text-base font-bold text-purple-900 uppercase dark:text-white">Flutterwave Mfb</p>
                </div>
            </div>
        </div>
        ...
        <div className="space-y-4 mb-10">
            ...
            {paymentStatus === 'failed' && (
              <div className="bg-red-50 border border-red-100 p-4 rounded-2xl animate-in zoom-in duration-300">
                ...
                <p className="text-[10px] text-red-500 mt-1 font-medium">We couldn't verify your payment. Please ensure you've uploaded your receipt correctly.</p>
              </div>
            )}
...
const DashboardPage: React.FC = () => {
  ...
  return (
    <div className="w-full animate-in fade-in duration-500 pb-20 dark:text-white">
      ...
      {showWarning && (
        <div className="fixed top-40 left-1/2 -translate-x-1/2 w-[90%] max-w-sm bg-red-600 text-white p-4 rounded-2xl shadow-2xl z-[100] animate-in slide-in-from-top duration-300 flex items-center space-x-3 border border-white/20">
          <div className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center shrink-0">
            <i className="fas fa-exclamation-triangle text-xl"></i>
          </div>
          <div>
            <p className="text-[10px] font-bold uppercase opacity-80">Security Warning</p>
            <p className="text-[11px] font-black leading-tight">Do not buy PAYID from any vendor or scammers, buy from the app for safety.</p>
          </div>
        </div>
      )}
    </div>
